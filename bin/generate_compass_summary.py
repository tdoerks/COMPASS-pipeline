...
<body>
    ...
    <div class="disclaimer">
        ...
        <div class="disclaimer-text">
            This report is automatically generated by computational analysis. All results,
            interpretations, and visualizations should be independently verified before use in
            publication or clinical settings. Prophage predictions may include false positives/negatives,
            and AMR calls require confirmation with phenotypic testing. Data accuracy is not guaranteed.
        </div>
    </div>
    ...
    <div id="snp-analysis" class="tab-content">
        <div class="chart-container">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(500px, 1fr)); gap: 20px;">
                ...
                <div class="chart-wrapper" id="snpHeatmapWrapper">
                    <!-- Heatmap summary will be inserted here by JavaScript -->
                </div>
            </div>
