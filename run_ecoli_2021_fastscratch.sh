#!/bin/bash
#SBATCH --job-name=compass_ecoli_2021
...
echo "=========================================="
echo "COMPASS Pipeline - E. coli 2021"
...
export NXF_HOME=/fastscratch/tylerdoe/.nextflow_ecoli_2021

# Run pipeline for E. coli 2021 NARMS data
...
nextflow run main.nf \
    ...
    --skip_busco true \
    --outdir /fastscratch/tylerdoe/kansas_2021_ecoli \
    -w work_ecoli_2021 \
    -resume
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo ""
    echo "Results location: /fastscratch/tylerdoe/kansas_2021_ecoli"
    echo ""
    echo "Summary report (if generated):"
    echo "  - /fastscratch/tylerdoe/kansas_2021_ecoli/summary/compass_summary.html"
    echo "  - /fastscratch/tylerdoe/kansas_2021_ecoli/summary/compass_summary.tsv"
    echo ""
    echo "Note: This includes ALL US E. coli 2021 samples"
    echo "Expected: ~500-1000 samples for 2021"
else
