#!/bin/bash
#SBATCH --job-name=compass_ks_2018
...
echo "=========================================="
echo "COMPASS Pipeline - Kansas 2018"
...
# Run pipeline for Kansas 2018 NARMS data
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo ""
    echo "Results location: /fastscratch/tylerdoe/results_kansas_2018"
else
