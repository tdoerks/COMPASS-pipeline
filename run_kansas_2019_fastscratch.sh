#!/bin/bash
#SBATCH --job-name=compass_ks_2019
...
echo "=========================================="
echo "COMPASS Pipeline - Kansas 2019"
...
# Run pipeline for Kansas 2019 NARMS data
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    echo ""
    echo "Results location: /fastscratch/tylerdoe/results_kansas_2019"
else
